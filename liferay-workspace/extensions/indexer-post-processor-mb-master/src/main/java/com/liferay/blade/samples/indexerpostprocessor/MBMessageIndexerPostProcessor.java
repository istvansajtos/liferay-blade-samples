...
@Component(
	immediate = true,
	property = {
		"indexer.class.name=com.liferay.message.boards.internal.search.MBMessageIndexer"
//		"indexer.class.name=com.liferay.message.boards.model.MBMessage"
	},
	service = IndexerPostProcessor.class
)
public class MBMessageIndexerPostProcessor implements IndexerPostProcessor {
